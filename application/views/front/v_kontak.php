            ...
            <div id="wrapper" class="sixteen columns">
                ...
                <div id="content" class="contact">
                    ...
                    <div class="container section">
                        <div class="one-third column">
                            ...
                            <p>
                                Jl. Tour & Travel Bogor, Jawa Barat
                            </p>
                            <ul class="square">
                                <li>
                                    Telp : 0812 XXXXXXX
                                ...
                                <li>
                                    Email : Administrator45@gmail.com
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="container section end">
                        <div id="footer-about" class="one-fourth column">
                            ...
                            <p>
                                ...
                                <span>Jl. Tour & Travel Bogor, Jawa Barat</span>
                                <span>Telp: 0812 XXXXXXX</span>
                            </p>
                            <p>
                                <span>Telp: 0812 XXXXXXX</span>
                                <span>Fax: 021 XXXXXXX</span>
                                <span>Email: Administrator45@gmail.com</span>
                            </p>
                        </div>
                ...
                <div id="copyright">
                    <div class="container section end">
                        ...
                        <span id="text">Copyright &copy; <?php date_default_timezone_set('Asia/Jakarta'); echo date('Y');?> | Administrator </span>
